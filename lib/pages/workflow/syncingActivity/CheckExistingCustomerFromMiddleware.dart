...
import 'package:eco_los/pages/workflow/centerfoundation/bean/CenterFoundationBean.dart';*/
...
import 'package:eco_los/pages/workflow/syncingActivity/SyncingPurposeOfLoan.dart';
import 'package:eco_los/pages/workflow/syncingActivity/SyncingRepaymentFrequency.dart';
import 'package:eco_los/pages/workflow/syncingActivity/SyncingTransactionMode.dart';*/
...
class ChkExstngCustFrmMiddleware{
  ...
  Future<CustomerCheckBean>  syncCheckedDataToMiddleware () async {
    ...
    String bodyValue = await NetworkUtil.callPostService(prospectJson,
        Constant.myPublicURL.toString() + Constant.chkExstngCustIp.toString(), _headers);
    print("url " + Constant.apiURL.toString() + Constant.myPublicURL.toString() + Constant.chkExstngCustIp.toString());
...
class  CustomerCheckBean{
  ...
  factory CustomerCheckBean.fromMap(Map<String, dynamic> map,bool isTrue) {
    return CustomerCheckBean(
      ...
      merrormessage:[TablesColumnFile.merrormessage] as String
    );}
