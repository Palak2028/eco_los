...
import 'package:eco_los/pages/workflow/Savings/NewAccountOpening.dart';
import 'package:eco_los/pages/workflow/Savings/ViewMinistatementTable.dart';
...
import 'package:eco_los/pages/workflow/syncingActivity/GetMiniStatementFromMiddleware.dart';
...
//mainAxisAlignment: MainAxisAlignment.spaceAround,
                            ...
                            children: <Widget>[
                              Text(
                                "Open Date  :  " +
                                    items[index].mdateopen.toString(),
                                style: TextStyle(
                                    fontSize: 12.0, color: Colors.white),
                              ),
                            ],
            ...
            onPressed: () {
              setState(() {
                if (this.actionIcon.icon == Icons.search) {
                  ...
                  this.appBarTitle = new Text("Savings Account List");
