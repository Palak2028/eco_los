...
class _NewAccountOpeningState extends State<NewAccountOpening> {
  ...
  Widget build(BuildContext context) {
      ...
      body: new Form(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            new Card(
              child: new ListTile(
                title: new Text("Branch Code",style: TextStyle(color: Color(0xff795548))),
                subtitle: new Text(savingsListObj.mlbrcode.toString(),style: TextStyle(color: Color(0xff12D6F4))),
              ),
            ),
            new Card(
              child: new ListTile(
                title: new Text("Savings Account Number"),
    ...
    //  isExpanded: true,
    //hint:Text("Select"),
    decoration: InputDecoration(labelText: "Freeze Type"),
    // style: TextStyle(color: Colors.grey),
    ),),):Card(
              //color: Constant.mandatoryColor
              child:new DropdownButtonFormField(
