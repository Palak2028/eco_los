...
class SavingsCollectionList extends StatefulWidget {
  ...
  SavingsCollectionList(this.mcenterid, this.mgroupid,this.custNo, this.productNo, this.paginationCount);
...
class _SavingsCollectionList extends State<SavingsCollectionList> {
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  new Row(
                                    children: <Widget>[
                                      Text(
                                        "Total Balance: ${items[position].macttotbalfcy}",
                                        style: TextStyle(color: Colors.white),
                                      ),
                                      Text(
                                        "    Lien Amount: ${items[position].mtotallienfcy}",
                                        style: TextStyle(color: Colors.white),
                                      ),
                                    ],
                                  ),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            new Row(
                              children: <Widget>[
                                Text(
                                  "Total Balance: ${items[index].macttotbalfcy}",
                                  style: TextStyle(color: Colors.white),
                                ),
                                Text(
                                  "    Lien Amount: ${items[index].mtotallienfcy}",
                                  style: TextStyle(color: Colors.white),
                                ),
                              ],
                            ),
  ...
  Future<bool> callDialog() {
    globals.Dialog.onPop(context, 'Are you sure?',
        'Do you want Submit Collection List a', "CollectionSubmit");
  }
