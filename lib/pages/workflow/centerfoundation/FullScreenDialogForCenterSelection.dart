...
class FullScreenDialogForCenterSelectionState
            ...
            Expanded(
              child:  new Card(
                  child:new ListTile(
                    ...
                    title: Text(
                      "Center Name : ${ '${items[index].mcentername.trim()}'}\n",
              style: TextStyle(
                      ...
                      children: <Widget>[
                        ...
                        new Row(
                          children: <Widget>[
                            ...
                            new Text('Next Meeting Date:'+dateFormat.format(items[index].mnextmeetngdt), style: new TextStyle(
                        ...
                        new Row(
                          children: <Widget>[
                            ...
                            new Text('Meeting Day  :  '+'${items[index].mmeetingday.toString()}', style: new TextStyle(
                              color: Color(0xff07426A),
                              fontSize: 14.0,
                            ), ),
                            //new Text('${items[index].mnextmeetngdt.toString()}')
                        ...
                        new Row(
                          children: <Widget>[
                            ...
                            new Text('Meeting Frequency : '+'${items[index].mmeetingfreq}', style: new TextStyle(
                              color: Color(0xff07426A),
                              fontSize: 13.0,
                            ), ),                          ],
                        ),
  ...
  void _onTapItem(
      BuildContext context, CenterDetailsBean getCenterFoundationList) {
