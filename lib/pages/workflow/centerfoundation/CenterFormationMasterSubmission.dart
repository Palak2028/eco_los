                ...
                children: <Widget>[
                  ...
                  new TextFormField(
                    ...
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Center Name is required' : null
                        : "",
                  ...
                  new TextFormField(
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Branch  is required' : null
                        : "",
                  ...
                  new TextFormField(
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter District Name here',
                      labelText: 'District ',
                      hintStyle: TextStyle(color: Colors.grey),
                      labelStyle: TextStyle(color: Colors.grey),
                      border: UnderlineInputBorder(
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'District  is required' : null
                        : "",
                  ...
                  new TextFormField(
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter Sub-District Name here',
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Sub-District  is required' : null
                        : "",
                  ...
                  new TextFormField(
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Village Name is required' : null
                        : "",
                  ...
                  new TextFormField(
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter Village population here',
                      labelText: 'Village population',
                      hintStyle: TextStyle(color: Colors.grey),
                      labelStyle: TextStyle(color: Colors.grey),
                      border: UnderlineInputBorder(
                          borderSide: BorderSide(
                    ...
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Village population is required' : null
                        : "",
                    onSaved: (val) =>
                  ...
                  new TextFormField(
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter Distance from branch here',
                      labelText: 'Distance from branch',
                      hintStyle: TextStyle(color: Colors.grey),
                      labelStyle: TextStyle(color: Colors.grey),
                      border: UnderlineInputBorder(
                          borderSide: BorderSide(
                    ...
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty
                            ? 'Distance from branch is required'
                            : null
                        : "",
                    onSaved: (val) =>
                  ...
                  new TextFormField(
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Assign to is required' : null
                        : "",
                  ...
                  new Row(children: <Widget>[
                    new Expanded(
                      ...
                      decoration: new InputDecoration(
                        ...
                        hintText: 'Enter Assigning date',
                        labelText: 'Assigning date',
                        hintStyle: TextStyle(color: Colors.grey),
                        labelStyle: TextStyle(color: Colors.grey),
                        border: UnderlineInputBorder(
                            borderSide: BorderSide(
                  ...
                  new TextFormField(
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter Servey Type here',
                      labelText: 'Servey Type',
                      hintStyle: TextStyle(color: Colors.grey),
                      labelStyle: TextStyle(color: Colors.grey),
                      border: UnderlineInputBorder(
                          borderSide: BorderSide(
                    ...
                    inputFormatters: [new LengthLimitingTextInputFormatter(30)],
                    validator: (val) => isSubmitClicked
                        ? val.isEmpty ? 'Servey Type is required' : null
                        : "",
