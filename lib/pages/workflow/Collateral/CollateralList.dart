import 'package:eco_los/pages/workflow/Collateral/AddCollaterals.dart';
...
//mainAxisAlignment: MainAxisAlignment.spaceAround,
  ...
  void _addNewCollateral(String mleadsId,int mrefno,int trefno) {
    ...
    Navigator.push(
      ...
      new MaterialPageRoute(
          builder: (context) => new AddCollaterals(mleadsId:mleadsId,mrefno:mrefno,trefno:trefno
          )), //When Authorized Navigate to the next screen
    );
  }

  void _onTapItem(CollateralBasicSelectionBean item,String mleadsId,int mrefno,int trefno) {
    print("inside on tap gau det");
    Navigator.push(
      context,
      new MaterialPageRoute(
          builder: (context) => new AddCollaterals(mleadsId:mleadsId,mrefno:mrefno,trefno:trefno,collateralsDetailsPassedObject: item,
          )), //When Authorized Navigate to the next screen
    );
  }
  ...
  Future<Null> _AddCollateraBasedOnTyp(CollateralBasicSelectionBean collateralBasicSelectionBean) async{
    ...
    if(collateralBasicSelectionBean.collatrlTyp =='33'){
      await AppDatabase.get().selectCollateralVehicleBeanOnCollateralMTrefAndTrefno(collateralBasicSelectionBean.trefno,collateralBasicSelectionBean.mrefno,collateralBasicSelectionBean.mcreatedby).then((onValue){
        Navigator.push(
          context,
          new MaterialPageRoute(

              builder: (context) =>
              new CollateralVehicleMaster(collateralBasicSelectionBean,onValue)), //When Authorized Navigate to the next screen
        );
      });
      ...
      await AppDatabase.get().selectCollateralREMBeanOnCollateralMTrefAndTrefno(collateralBasicSelectionBean.trefno,collateralBasicSelectionBean.mrefno,collateralBasicSelectionBean.mcreatedby).then((onValue){
        Navigator.push(
          ...
          new MaterialPageRoute(
              ...
              builder: (context) =>
              new CollateralsREMMaster(collateralBasicSelectionBean,onValue)), //When Authorized Navigate to the next screen
        );
      });
        }
  }
