...
/*  @override
  ...
  factory GRTBean.fromMiddleware(
    ...
    return GRTBean(
        ...
        mremarks: map[TablesColumnFile.mremark] as String,
        mhouseVerifiImg:  map[TablesColumnFile.mhouseVerifiImg] as String,
      checkListGRTBean:null
      //map[TablesColumnFile.checkListGrtDetails]==null?null:map[TablesColumnFile.checkListGrtDetails].map<CheckListGRTBean>((i) => CheckListGRTBean.fromMiddleware(i))
        //  .toList(),
    );
  }
