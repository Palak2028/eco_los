...
*/
              ...
              child: new Form(
                  ...
                  child: SingleChildScrollView(
                      ...
                      Container(
                        ...
                        child:new ListTile(
                          title: new Text("State",style: TextStyle(color: Colors.grey),),
                          subtitle:
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: new DropdownButtonFormField(
                                ...
                                //  isExpanded: true,
                                //hint:Text("Select"),
                                decoration: InputDecoration(labelText: "Nominee Relation"),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: new DropdownButtonFormField(
                                ...
                                //  isExpanded: true,
                                //hint:Text("Select"),
                                decoration: InputDecoration(labelText: "Applicant ID 2"),
                                // style: TextStyle(color: Colors.grey),
                              ),
                            ),
                          ),
  ...
  Future _scanQR() async {
    try {
      ...
      if (/*ex.code == BarcodeScanner.CameraAccessDenied*/true) {
        setState(() {
  ...
  Future<void> postSms(int contactNo) async {
    ...
    try {
      ...
      String body1 =
          'apiKey=Vlsq0LknQoo-WOAGuq3V7jyucsWvr2hfPgW6mdSeh5&numbers=91${contactNo}&sender=SAIJAF&message=${OTP}';
      final response =
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                  Text('Modification Done For  Named: ${applicantName}'),
                ],
              ),
            ),
            actions: <Widget>[
