...
import 'package:eco_los/pages/workflow/creditBereau/Bean/ProspectViewBean.dart';
...
import 'package:eco_los/Utilities/app_constant.dart'
    as constant;
import 'package:eco_los/pages/workflow/creditBereau/CreditBereauResult.dart';
      ...
      child: new Card(
          ...
          child: new ListTile(
            ...
            trailing: Column(
              children: <Widget>[
                new Text(
                    "Create Dt ${formatter.format(items2[index].mcreateddt)}",
                    style: TextStyle(color: Colors.black,fontSize: 10.0),
                ),
                new Icon(
                  Icons.check,
                  ...
                  child: new ListTile(
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        new Text(
                          "Create Dt ${formatter.format(items2[position].mcreateddt)}",
                          style: TextStyle(color: Colors.black,fontSize: 10.0),
