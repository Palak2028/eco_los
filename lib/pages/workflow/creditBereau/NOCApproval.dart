...
class _NOCApproval extends State<NOCApproval> {
                    ...
                    new Column(
                      ...
                      children: <Widget>[
                        ...
                        new Row(
                          children: <Widget>[
                            new Text(
                              "Curr Bal  ${items[index].mcurrentbalance}",
                              style: TextStyle(),
                            ),
                          ],
                        )
                      ...
                      Flexible(
                          ...
                          new Column(
                            ...
                            children: <Widget>[
                              new Row(
                                children: <Widget>[new Text(
                                  "OD :  ${items[position].moverdueamount}",
                                  style: TextStyle(),
                                ),],
                              ),
                              new Row(
                                children: <Widget>[
                                  new Text(
                                    "Curr Bal  ${items[position].mcurrentbalance}",
                                    style: TextStyle(),
                                  ),
                                ],
                              )
  ...
  Future<void> routeNOCResult(status) async {
    ...
    if(globals.reportingUser==null||globals.reportingUser=="null"||globals.reportingUser.trim()==""){
      _scaffoldKey.currentState.showSnackBar(
          SnackBar(
            content: const Text('Reporting User Not Set'),
  ...
  Future<void> showConfirmationAlert(int prospectStatus) async {
    return showDialog<void>(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context) {
        return AlertDialog(
          title:new Text("Confirmation Alert"),
          content:prospectStatus==5? new Row(
            children: <Widget>[
              new Text("Are you sure you want to "),
              new Text("Disaproove",style: TextStyle(color: Colors.red),)
            ],
          ):new Row(
            children: <Widget>[
              new Text("Are you sure you want to "),
              new Text("Approve",style: TextStyle(color: Colors.green),)
            ],
          ),
          actions: <Widget>[
            FlatButton(
