...
import 'package:eco_los/pages/workflow/customerFormation/FullScreenDialogPPIAnswerPickList.dart';
import 'package:eco_los/pages/workflow/customerFormation/ViewCustomerFormationFamilyDetails.dart';
import 'package:eco_los/pages/workflow/customerFormation/ViewCustomerFormationPPIDetails.dart';
import 'package:eco_los/pages/workflow/customerFormation/bean/PPIBean.dart';
...
//set answerdesc when comin back
        ...
        child: ListView(padding: EdgeInsets.all(20.0), children: <Widget>[
          new DropdownButtonFormField(
            ...
            decoration: InputDecoration(labelText: globals.dropdownCaptionsPPIDetails[0]),
                 ...
                 new Card(
                   child: new ListTile(
                       title: new Text("Select PPI Answer"),
                       subtitle: answerdesc == null || answerdesc=='null'
                           ? new Text("")
                           : new Text("PPI : ${answerdesc}"),
                       onTap: () => getPPIAns("PPI",
  ...
  void addToList() {
    ...
    if(CustomerFormationMasterTabsState.ppiBean.mitem!=null&&CustomerFormationMasterTabsState.ppiBean.mitem!="null"){
      ...
      globals.Dialog.alertPopup(context,"Error","Please Add PPI Question, PPI question should not be blank","PPI" );
    }
  }
