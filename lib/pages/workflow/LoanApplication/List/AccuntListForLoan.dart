...
class AccuntListForLoan extends StatefulWidget {
  ...
  final String mcurcd;
  final int mcusttrefno;
  final int mcustmrefno;
  AccuntListForLoan(this.mcurcd,this.mcusttrefno,this.mcustmrefno);
  @override
...
//mainAxisAlignment: MainAxisAlignment.spaceAround,
  ...
  Widget build(BuildContext context) {
    ...
    if (/*storedItems.isEmpty||storedItems==null*/ count == 1 || count == 2) {
      ...
      future: AppDatabase.get().getAccountList(widget.mcurcd, widget.mcusttrefno,widget.mcustmrefno).then(
