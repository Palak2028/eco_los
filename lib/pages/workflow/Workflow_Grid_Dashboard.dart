import 'package:eco_los/pages/home/LoanDashboard.dart';
import 'package:eco_los/pages/workflow/BranchMaster/BranchMasterBean.dart';
import 'package:eco_los/pages/workflow/collection/DeviceSetting.dart';
import 'package:eco_los/pages/workflow/utilityBillPayment/UtilityBillPayment.dart';
...
import 'package:eco_los/pages/workflow/CGT/CGT2.dart';
import 'package:eco_los/pages/workflow/GRT/GRTDocumentVerification.dart';
import 'package:eco_los/pages/workflow/GRT/GRTTab.dart';

import 'package:eco_los/pages/workflow/GroupFormation/GroupFormationMasterSubmissionListView.dart';
import 'package:eco_los/pages/workflow/LoanApplication/List/CustomerLoanDetailsList.dart';
import 'package:eco_los/pages/workflow/LoanApplication/LoanLimitDetails.dart';
import 'package:eco_los/pages/workflow/LoanUtilization/LoanUtilizationList.dart';
import 'package:eco_los/pages/workflow/Savings/SavingsList.dart';
import 'package:eco_los/pages/workflow/Savings/bean/SavingsListBean.dart';
import 'package:eco_los/pages/workflow/SpeedoMeter/SpeedoMeter.dart';
import 'package:eco_los/pages/workflow/SpeedoMeter/list/SpeedoMeterList.dart';
import 'package:eco_los/pages/workflow/centerfoundation/CenterFormationMasterListView.dart';
import 'package:eco_los/pages/workflow/centerfoundation/CenterFormationMasterSubmission.dart';
...
import 'package:eco_los/pages/workflow/creditBereau/CreditBereauCallSubmisiion.dart';
import 'package:eco_los/pages/workflow/creditBereau/CreditBereauDataTable.dart';
import 'package:eco_los/pages/workflow/creditBereau/NOCApprovalList.dart';
...
import 'package:eco_los/pages/workflow/syncingActivity/SyncingActivityMenuList.dart';
import 'package:eco_los/pages/workflow/termDeposit/TermDepositDashboard.dart';
import 'package:eco_los/pages/workflow/villageservey/Home_VillageServey_Tabs.dart';
...
String centerCaption = "Center";
    ...
    return new GestureDetector(
      child: new RaisedButton(
          ...
          onPressed: () {
            ...
            new MaterialPageRoute(
                builder: (context) =>
                new CenterFormationMasterListView()), //When Authorized Navigate to the next screen
          );*/
              globals.Dialog.alertPopup(context, "This module is locked",
                  "Please ask support team To open this", "Dashboard");
            } /*else if (name == "CB Results") {
              print("CB Results");
              Navigator.push(
                context,
                new MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    return
      ...
      children: <Widget>[
        /* gestureDetector("Village creation", "assets/village.png"),
        gestureDetector("Village Summary", "assets/village.png"),*/
        // gestureDetector(centerCaption, "assets/create_centers.png"),
        //gestureDetector("Group Creation", "assets/group_foundation.png"),
        //gestureDetector("Credit Check", "assets/prospect_creation.png"),
       // gestureDetector("NOC Approval", "assets/result.png"),
        gestureDetector("Customers", "assets/CIF_COLORFUL.png"),
        //gestureDetector("Customer 360", "assets/Customer360.png"),
        //gestureDetector("SMS Verification", "assets/SmsVerification.png"),
       // gestureDetector("CB Results", "assets/result.png"),
        //gestureDetector("Qr Scanner", "assets/qr_code_scanner.png"),
        gestureDetector("Loans", "assets/Loan.png"),
      //  gestureDetector("Printing", "assets/CIF_COLORFUL.png"),
        //gestureDetector("Savings", "assets/loanUtilization.png"),
        //gestureDetector("Term Deposit", "assets/loanUtilization.png"),
        //gestureDetector("Insurance", "assets/Insurance.png"),
       // gestureDetector("SpeedoMeter", "assets/speedometer.png"),
       // gestureDetector("Utility Bill", "assets/speedometer.png"),
        //gestureDetector("Transactions", "assets/speedometer.png"),
       // gestureDetector("Syncing Activity", "assets/Syncing.png"),
