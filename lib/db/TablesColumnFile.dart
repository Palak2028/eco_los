...
//Credit Bereau Master table
  ...
  static final maccstatus='maccstatus';
  static final migyn='migyn';
...
//Customer personal info 1	//Customer personal info 1
  ...
  static final minvestment="minvestment";
  static final mrental="mrental";
  static final mowneruse="mowneruse";
...
//socialFinancial Details	//socialFinancial Details
  ...
  static final tbanktrefno="tbanktrefno";
  static final mbanktrefno="mbanktrefno";
  static final maccno="maccno";
  static final mcurcode="mcurcode";
  static final mbankname="mbankname";
  static final mbranch="mbranch";
  static final maccbal="maccbal";
  static final misusefordis="misusefordis";
  static final house=	   "house";
...
//SpeedoMeter
  ...
  static final mfatherfname =	  "mfatherfname";
  static final mfathermname =	  "mfathermname";
  static final mfatherlname =	  "mfatherlname";
...
//FamilyDetails
  ...
  static final mreverseRelationship="mreverserelationship";
...
*/
  ...
  static final bankDetails = "bankDetails";
...
static final mTableadsid = "mtableadsid";
  ...
  static final mleadstatusdesc="mleadstatusdesc";
  ...
  static final mtypeofloan="mtypeofloan";
  static final missecuredloan="missecuredloan";
  static final mrepaymentfreq="mrepaymentfreq";
  ...
  static final loanCycleParameterSecondaryComposite="loanCycleParameterSecondaryCompositeEntity";
  static final loanCycleParameterPrimaryComposite="loanCycleParameterPrimaryCompositeEntity";
  ...
  static final mexecutiondate="mexecutiondate";
...
//Offset Interest Master - for TD
  ...
  static final loanApprovalLimitComposite =
      "loanApprovalLimitCompositeEntity";
  ...
  static final systemParameterCompositeEntity = "systemParameterCompositeEntity";
  ...
  static final tdOffsetInterestSlabCompositeEntity = "tdOffsetInterestSlabCompositeEntity";
  static final maccttype = "maccttype";
 //Bussiness Details
  static final mdepartment="mdepartment";
  static final mposition="mposition";
  static final mbusinesstype=	"mbusinesstype";
  static final mdateofincorporation=	"mdateofincorporation";
  static final mbusinessownerandshareholdingpercentage=	"mbusinessownerandshareholdingpercentage";
  static final mtotalmanpower=	"mtotalmanpower";
  static final mcompanycategory=	"mcompanycategory";
  static final mmanagerdetails=	"mmanagerdetails";
  static final mcapital=	"mcapital";
  static final mcostofgoodssold=	"mcostofgoodssold";
  static final moperationexpenditure=	"moperationexpenditure";
  static final mnetprofit=	"mnetprofit";
  static final mnetincome=	"mnetincome";
  static final mincomefromothersource=	"mincomefromothersource";
  ...
  static final mlandfixedassets = "mfixedassets";
 ...
 // static final mequity = "mequity";
   ...
   static final misselfemp ="misselfemp";

static final mOneDayGapNeededForGRT = "mOneDayGapNeededForGRT";
  static final mDailingCode = "mDailingCode";
  static final mIsWasasa = "mIsWasasa";
  ...
  static final macctstatdesc = "macctstatdesc";
    static final msumpresentamt = "msumpresentamt";
  static final msumnextmonthamount = "msumnextmonthamount";
  static final tincomerefno = "tincomerefno";
  static final mincomerefno = "mincomerefno";
  static final mtotalrevenuep = "mtotalrevenuep";
  static final mtotalrevenuenm = "mtotalrevenuenm";
  static final mgrossprofitfirstp = "mgrossprofitfirstp";
  static final mgrossprofitfirstnm = "mgrossprofitfirstnm";
  static final mrevenuefirstp = "mrevenuefirstp";
  static final mrevenuefirstnm = "mrevenuefirstnm";
  static final mgoodcostfirstp = "mgoodcostfirstp";
  static final mgoodcostfirstnm = "mgoodcostfirstnm";
  static final mgrossprofitsecondp = "mgrossprofitsecondp";
  static final mgrossprofitsecondnm = "mgrossprofitsecondnm";
  static final mrevenuesecondp = "mrevenuesecondp";
  static final mrevenuesecondnm = "mrevenuesecondnm";
  static final mgoodcostsecondp = "mgoodcostsecondp";
  static final mgoodcostsecondnm = "mgoodcostsecondnm";
  static final motherrevenuep = "motherrevenuep";
  static final motherrevenuenm = "motherrevenuenm";
  static final mtotalopexpp = "mtotalopexpp";
  static final mtotalopexpnm = "mtotalopexpnm";
  static final mopexpfirstp = "mopexpfirstp";
  static final mopexpfirstnm = "mopexpfirstnm";
  static final mpersonalexpfirstp = "mpersonalexpfirstp";
  static final mpersonalexpfirstnm = "mpersonalexpfirstnm";
  static final mgeneralexpfirstp = "mgeneralexpfirstp";
  static final mgeneralexpfirstnm = "mgeneralexpfirstnm";
  static final motherexpfirstp = "motherexpfirstp";
  static final motherexpfirstnm = "motherexpfirstnm";
  static final mopexpsecondp = "mopexpsecondp";
  static final mopexpsecondnm = "mopexpsecondnm";
  static final mpersonalexpsecondp = "mpersonalexpsecondp";
  static final mpersonalexpsecondnm = "mpersonalexpsecondnm";
  static final mgeneralexpsecondp = "mgeneralexpsecondp";
  static final mgeneralexpsecondnm = "mgeneralexpsecondnm";
  static final motherexpsecondp = "motherexpsecondp";
  static final motherexpsecondnm = "motherexpsecondnm";
  static final mtaxexpp = "mtaxexpp";
  static final mtaxexpnm = "mtaxexpnm";
  static final mnetincomep = "mnetincomep";
  static final mnetincomenm = "mnetincomenm";
  static final tfinancialstmntrefno = "tfinancialstmntrefno";
  static final mfinancialstmntrefno = "mfinancialstmntrefno";
  static final mgrossprofitmargin = "mgrossprofitmargin";
  static final mcurrentratio = "mcurrentratio";
  static final mdebtratio = "mdebtratio";
  static final mtotcurasset = "mtotcurasset";
  static final mtotcurliabilities = "mtotcurliabilities";
  static final mworkngcapital = "mworkngcapital";
  static final mavginventory = "mavginventory";
  static final mavgaccreceivables = "mavgaccreceivables";
  static final mavgaccpayables = "mavgaccpayables";
  static final mcogs = "mcogs";
  static final msales = "msales";
  static final mpurchases = "mpurchases";
  static final minvconperiod = "minvconperiod";
  static final mrecconperiod = "mrecconperiod";
  static final mpayconperiod = "mpayconperiod";
  static final mworkngcapitalcycle = "mworkngcapitalcycle";


  static final fixedAssetsList = "customerFixedAssetEntity";
  static final currentAssetsList = "customerCurrentAssetEntity";
  static final longTermLiabilitiesList = "customerLongTermLiabilityEntity";
  static final shortTermLiabilitiesList = "customerShortTermLiabilityEntity";
  static final equityList = "customerEquityEntity";
  static final incomeStatementList = "customerIncomeStatementEntity";
  static final financialStmntList = "customerFinancialStatementEntity";


  static final mland = "mland";
  static final mlandpresentamt = "mlandpresentamt";
  static final mlandnextmonthamount = "mlandnextmonthamount";

  static final mbuildng = "mbuildng";
  static final mbuildngpresentamt = "mbuildngpresentamt";
  static final mbuildngnextmonthamount = "mbuildngnextmonthamount";


  static final mmachnryorequp = "mmachnryorequp";
  static final mmachnryorequppresentamt = "mmachnryorequppresentamt";
  static final mmachnryorequpnextmonthamount = "mmachnryorequpnextmonthamount";

  static final mmeansandtransprt = "mmeansandtransprt";
  static final mmeansandtransprtpresentamt = "mmeansandtransprtpresentamt";
  static final mmeansandtransprtnextmonthamount = "mmeansandtransprtnextmonthamount";


  static final mothrs = "mothrs";
  static final mothrspresentamt = "mothrspresentamt";
  static final mothrsnextmonthamount = "mothrsnextmonthamount";


  static final  mcash=	 "mcash";
  static final mcashpresentamt=	"mcashpresentamt";
  static final mcashnextmonthamount=	"mcashnextmonthamount";

  static final maccntrecvbl=	"maccntrecvbl";
  static final maccntrecvblpresentamt=	"maccntrecvblpresentamt";
  static final maccntrecvblnextmonthamount=	"maccntrecvblnextmonthamount";

  static final minventry=	"minventry";
  static final minventrypresentamt=	"minventrypresentamt";
  static final minventrynextmonthamount=	"minventrynextmonthamount";

  static final mprepaid=	 "mprepaid";
  static final mprepaidpresentamt=	"mprepaidpresentamt";
  static final mprepaidnextmonthamount=	"mprepaidnextmonthamount";
...
//Collaterals
  ...
  //static final mrelationwithapplicant ="mrelationwithapplicant";
  static final minsurance ="minsurance";
  ...
  static final mnametitle2= 'mnametitle2';
  static final mlongname2 =	  "mlongname2";
  static final mfname2 =	  "mfname2";
  static final mmname2 =	  "mmname2";
  static final mlname2 =	  "mlname2";
  ...
  static final misearngmembr = "misearngmembr";
  static final misstudyingmembr = "misstudyingmembr";



  static final mempfrom = "mempfrom";
  static final mempto = "mempto";
  static final mincomefromothrsrc = "mincomefromothrsrc";
 ...
 // static final mloanmrefno="mloanmrefno";
  ...
  //Collelateral REM land and building
  ...
  //Collelateral REM land and house
  ...
  static final mtotalman = "mtotalman";
  static final mtotalwomen = "mtotalwomen";

  static final mfield3="mfield3";
  static final mfield3presentamt="mfield3presentamt";
  static final mfield3nextmonthamount="mfield3nextmonthamount";
  static final mfield4 = "mfield4";
  static final mfield4presentamt = "mfield4presentamt";
  static final mfield4nextmonthamount = "mfield4nextmonthamount";

  static final ttotlexpntrefno= "ttotlexpntrefno";
  static final mtotlexpnmrefno= "mtotlexpnmrefno";
  static final mlivngexpns = "mlivngexpns";
  static final mtotlcommexpns = "mtotlcommexpns";
  static final meduexpns = "meduexpns";
  static final mmedexpns = "mmedexpns";
  static final mtotlfamexpns = "mtotlfamexpns";
  static final mloanservexpns = "mloanservexpns";
  static final mcredcrdexpns = "mcredcrdexpns";
  static final mrntlexpns = "mrntlexpns";
  static final mlghtwtrexpns = "mlghtwtrexpns";
  static final mvechtrnsprtexpns = "mvechtrnsprtexpns";
  static final mothrexpns = "mothrexpns";
  static final mothrdebtrepymntexpns = "mothrdebtrepymntexpns";
  static final mtotldebtexpns = "mtotldebtexpns";
  static final totalExpenditureDetailsBean = "customerTotalEpenditureEntity";


  static final mid3issuedate =	  "mid3issuedate";
  static final mid3expdate =	  "mid3expdate";
  static final missngautryt1 =	  "missngautryt1";
  static final missngautryt2 =	  "missngautryt2";
  static final missngautryt3 =	  "missngautryt3";
  static final mtypeofid3 =	  "mtypeofid3";
  static final middesc3 =	  "middesc3";
  static final macctbal ="macctbal";
  static final mbusstype = "mbusstype";
  static final mischldrn = "mischldrn";

  static final mfromdate = "mfromdate";
  static final mtodate = "mtodate";
  static final macctno = "macctno";
  static final mrestructrdloan = "mrestructrdloan";
  static final msvngamount = "msvngamount";


  static final msrcname = "msrcname";
  static final mnoofempincmpny = "mnoofempincmpny";
  static final myrsofexpinyrs = "myrsofexpinyrs";
  static final myrsofexpinmnths = "myrsofexpinmnths";
  static final mstatusofemp = "mstatusofemp";
  static final mtagtmrkt = "mtagtmrkt";
  static final mstrtgy = "mstrtgy";
  static final mbussprocss = "mbussprocss";
  static final mcomptrmekt = "mcomptrmekt";
  static final mprofession = "mprofession";

  static final mtarget = "mtarget";
  static final mownership = "mownership";
  
  
  static final mdust= 	 "mdust";
  static final mtrafficcongandobs =	  "mtrafficcongandobs";
  static final mvibration =	  "mvibration";
  static final mfumes =	  "mfumes";
  static final modours =	  "modours";
  static final mnoise =	  "mnoise";
  static final mnocomissue =	  "mnocomissue";
  static final mnodesigperson =	  "mnodesigperson";
  static final mdispandressetle =	  "mdispandressetle";
  static final mlandacqreq =	  "mlandacqreq";
  static final mnoissue =	  "mnoissue";
  static final marchimp =	  "marchimp";
  static final msiteofcultural =	  "msiteofcultural";
  static final mcomplaintsfromneig =	  "mcomplaintsfromneig";
  static final mimpactofindgenous =	  "mimpactofindgenous";
  static final mimpactonlocal =	  "mimpactonlocal";
  static final mnorecognitionofemp =	  "mnorecognitionofemp";
  static final mlabourunion =	  "mlabourunion";
  static final mnolabissue =	  "mnolabissue";
  static final mnopersonalprotectiveEquip =	  "mnopersonalprotectiveEquip";
  static final mnoprocessforemployees =	  "mnoprocessforemployees";
  static final mchildoffrcdlabour =	  "mchildoffrcdlabour";
  static final mempblwminage =	  "mempblwminage";
  static final mpayblwminwage =	  "mpayblwminwage";
  static final munequalOpp =	  "munequalOpp";
  static final minadequatetermsofemp =	  "minadequatetermsofemp";
  static final minediquateworkingcond =	  "minediquateworkingcond";
  static final muinadequateemployeehealth =	  "muinadequateemployeehealth";
  static final mnontarget= "mnontarget";
  static final mcategoryc = "mcategoryc";
  static final mcategoryb= "mcategoryb";
  static final mcategorya = "mcategorya";
  static final mcomntfrmoff = "mcomntfrmoff";
  static final mdecision = "mdecision";
  static final msign = "msign";
  static final mnameofoff = "mnameofoff";
  static final date = "date";
  static final mexclistchecked=  "mexclistchecked";
  static final misbrwrinlist=  "misbrwrinlist";
  static final mnontrgtcust=   "mnontrgtcust";
  static final misbrwrinnontrgt=   "misbrwrinnontrgt";
  static final mairemssn=  "mairemssn";
  static final maeapplglrequire=   "maeapplglrequire";
  static final maecmplncstatus=  "maecmplncstatus";
  static final maeevediance=   "maeevediance";
  static final mwastewater=  "mwastewater";
  static final mwwapplglrequire=   "mwwapplglrequire";
  static final mwwcmplncstatus=  "mwwcmplncstatus";
  static final mwwevediance=   "mwwevediance";
  static final msolidnhrdauswaste=   "msolidnhrdauswaste";
  static final mshapplglrequire=   "mshapplglrequire";
  static final mshcmplncstatus=  "mshcmplncstatus";
  static final mshevediance=   "mshevediance";
  static final mhrdzchemnfule= "mhrdzchemnfule";
  static final mhcapplglrequire= "mhcapplglrequire";
  static final mhccmplncstatus=  "mhccmplncstatus";
  static final mhcevediance= "mhcevediance";
  static final mrescnsmpt="mrescnsmpt";
  static final mnuisance="mnuisance";




  static final  tesmsrefno = "tesmsrefno";
  static final  mesmsrefno = "mesmsrefno";
  static final  esmsentity = "customerEsmsEntity";
  static final  mdesignation = "mdesignation";
  static final  miscpemp = "miscpemp";
  static final  mrankofemp = "mrankofemp";
  static final  mresstatus = "mresstatus";
  static final misleavingwithappcnt="misleavingwithappcnt";
  static final mdedupnationalid="mdedupnationalid";
  static final mempid ="mempid";

  static final	mrevsrc1 =	  "mrevsrc1";
  static final	mrevsrc2=	  "mrevsrc2";
  static final	mnamesrc1 =	  "mnamesrc1";
  static final	mnamesrc2=	  "mnamesrc2";
  static final	mrev1 =	  "mrev1";
  static final	mrev2=	  "mrev2";
  static final	mexp1 =	  "mexp1";
  static final	mexp2=	  "mexp2";
  static final	minc1 =	  "minc1";
  static final	minc2=	  "minc2";
  static final	mrevtotal =	  "mrevtotal";
  static final	mexptotal =	  "mexptotal";
  static final	minctotal =	  "minctotal";
  static final	mpldggurproprty1 =	  "mpldggurproprty1";
  static final	mpldggurproprty2=	  "mpldggurproprty2";
  static final	mpldggurproprty3=	  "mpldggurproprty3";
  static final	msize1 =	  "msize1";
  static final	msize2=	  "msize2";
  static final	msize3 =	  "msize3";
  static final	mcollvalue1 =	  "mcollvalue1";
  static final	mcollvalue2=	  "mcollvalue2";
  static final	mcollvalue3 =	  "mcollvalue3";
  static final	mcollvaluetotal=	  "mcollvaluetotal";

  static final misprimarysrcincome = "misprimarysrcincome";
  static final mcompanyname = "mcompanyname";
  static final mbussstatus = "mbussstatus";
  static final mdsitrequiretorefroff ="mdsitrequiretorefroff";
  ...
  static final triskratingsrefno	= "triskratingsrefno";
  static final mriskratingsrefno	= "mesmsrefno";
  static final mtypeofaccount	= "mtypeofaccount";
  static final mcifno	= "mcifno";
  static final vmpurposeofacct	= "vmpurposeofacct";
  static final mcountryrisk	= "mcountryrisk";
  static final mvisaperiod	= "mvisaperiod";
  static final mvisavalid	= "mvisavalid";
  static final mvisatype	= "mvisatype";
  static final mnatureofbuss	= "mnatureofbuss";
  static final mhwwsacctopn	= "mhwwsacctopn";
  static final mnetwrth	= "mnetwrth";
  static final mexpectedvalue	= "mexpectedvalue";
  static final mnooftransmnthly	= "mnooftransmnthly";
  static final mhighnetwrth	= "mhighnetwrth";
  static final mprcdservrskque1	= "mprcdservrskque1";
  static final riskratingsentity	= "customerRiskRatingsEntity";
...
//Document Collector
  static final mforeignindicator	= "mforeignindicator";
  static final mimgtype	= "mimgtype";
  static final mcustomertype="mcustomertype";
  static final mimgtypedesc	= "mimgtypedesc";
  static final mimgsubtype	= "mimgsubtype";
  static final mcomment	= "mcomment";
  static final imgstring	= "imgstring";

  static final mdoctno	= "mdoctno";
  static final missuingauth	= "missuingauth";
  static final missuedate	= "missuedate";

//ENDS
  static final bluetoothAddress = "bluetoothAddress";

  static final RESEDENCYADDRESSMCODE = "RESEDENCYADDRESSMCODE";
